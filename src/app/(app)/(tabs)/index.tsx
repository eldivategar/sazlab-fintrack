...
export default function DashboardScreen() {
  ...
  const getCategoryEmoji = (cat: string) => {
    ...
    if (
      clean.includes("cash") ||
      clean.includes("tunai") ||
      clean.includes("dompet")
    )
      return "💵";
    return "💰";
  };
      ...
      <View style={styles.loadingOverlay}>
        ...
        <AnimatedCard index={0} style={styles.loadingBox}>
          ...
          <Text style={styles.loadingSubtitle}>
            Menyiapkan Spreadsheet 'SiPaling Hemat Data' Anda...
          </Text>
        </AnimatedCard>
      </View>
    );
  ...
  const { todayTx, yesterdayTx, olderTx } =
    groupTransactions(latestTransactions);

  // Budget Ratios & Limits
  const cashLimit = totalBudgetCash !== null ? totalBudgetCash : 0;
  const cashRemaining = sisaBudgetCash !== null ? sisaBudgetCash : 0;
  const cashSpent = cashLimit - cashRemaining;

  const paylaterLimit = budgetPaylater !== null ? budgetPaylater : 0;
  const paylaterRemaining =
  ...
  const getInsight = () => {
    if (thisMonthTransactions.length === 0) {
      return {
        ...
        description:
          "Mulai catat transaksi pertama untuk mendapatkan insight keuangan.",
      };
    }
    ...
    if (totalExpenseThisMonth === 0) {
      return {
        ...
        description:
          "Belum ada pengeluaran tercatat bulan ini. Tabungan Anda tumbuh aman!",
      };
    }
    ...
    if (isTemplateFormat) {
      ...
      const paylaterSpentRatio =
        paylaterLimit > 0 ? paylaterSpent / paylaterLimit : 0;
        ...
        <View style={styles.cardRight}>
          ...
          <View
            style={[
              ...
              {
                backgroundColor:
                  tx.pembayaran === "Paylater" ? "#FFEBF0" : "#E6F7F9",
              },
            ]}
          >
            <Text
    ...
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      ...
      <ScreenTransition triggerKey={String(isFocused)} style={{ flex: 1 }}>
        ...
        >
          ...
          >
            <ImageBackground
              source={require("../../../../assets/images/bg-grad.png")}
            ...
            >
              <View style={styles.heroTopRow}>
                ...
                <Pressable style={styles.sparkleBtn}>
                  <Ionicons name="sparkles" size={16} color="#FF7597" />
                </Pressable>
              </View>

              <Text style={styles.heroLabel}>TOTAL SALDO / ANGGARAN</Text>

              {totalBudgetCash === 0 || totalBudgetCash === null ? (
                ...
                <Text style={styles.heroAmount}>
                  {formatRupiah(
                    totalSisaSaldo !== null ? totalSisaSaldo : totalBudget || 0,
                  )}
                </Text>
              )}
              ...
              <View style={styles.heroGlassContainer}>
                ...
                <View style={styles.heroGlassItem}>
                  <View style={styles.heroGlassItemTop}>
                    <View style={styles.heroGlassIcon}>
                      <Ionicons name="wallet" size={16} color="#FF7597" />
                    </View>
                ...
                {/* Vertical Divider */}
                <View style={styles.heroGlassDivider} />

                {/* Paylater Section */}
                <View style={styles.heroGlassItem}>
                  <View style={styles.heroGlassItemTop}>
                    <View style={styles.heroGlassIcon}>
                      <Ionicons name="card" size={16} color="#76C6D3" />
                    </View>
          ...
          <AnimatedCard index={2} triggerKey={String(isFocused)}>
            <View style={styles.summarySection}>
              ...
              <View
                style={[
                  styles.summaryCard,
                  { borderColor: "rgba(255, 144, 187, 0.3)" },
                ]}
              >
                <View
                  style={[
              ...
              {latestTransactions.length === 0 ? (
                <View style={styles.emptyContainer}>
                  ...
                  <Text style={styles.emptySubtext}>
                    Gunakan Catat Manual atau Input Suara untuk menambah
                    transaksi.
                  </Text>
                  <Pressable
                    onPress={() => router.push("/(app)/add-transaction")}
